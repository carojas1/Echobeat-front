...
// Admin emails
const ADMIN_EMAILS = ["carojas@sudamericano.edu.ec"];
    ...
    try {
      ...
      if (error && typeof error === "object" && "code" in error) {
        ...
        if (code === "auth/user-not-found") msg = "Usuario no encontrado";
          ...
          msg = "Muchos intentos. Espera un momento";
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      if (user) {
        ...
        setShowToast(true);
        setTimeout(() => redirectAfterLogin(user.email), 500);
      }
    } catch (error: unknown) {
      ...
      <IonContent className="ion-padding" scrollY={true} fullscreen={true}>
        <div className="login-container">
          ...
          <div className="login-header">
            ...
            <h1>EchoBeat</h1>
            <p className="subtitle">Tu música, tu ritmo</p>
          </div>
